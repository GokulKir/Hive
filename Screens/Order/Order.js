    ...
    <View style={styles.container}>
      <ScrollView>
        <View style={{width: '100%', height: 234, backgroundColor: '#FFCBAE'}}>
          <View style={{marginTop: 24, marginLeft: 34}}>
            ...
            <View style={{alignItems: 'center'}}>
              <Text style={{marginTop: 15, marginRight: 35, fontSize: 15}}>
                You must verify your identity, please submit the required
                documents to get verified. As soon as you will be verified then
                you will be able to get online orders
              </Text>
            </View>
          </View>
        ...
        <View style={{alignItems: 'center'}}>
          ...
          <View
            style={{width: '100%', height: 125, backgroundColor: '#ffffff'}}>
            <View>
              <Text
                style={{
                  color: '#1DA1F2',
            ...
            <View style={{flexDirection: 'row', marginLeft: 22, marginTop: 5}}>
              <Image
                style={{marginTop: 7, marginLeft: 2, width: 17, height: 17}}
              ...
              <Text style={{fontSize: 12, marginLeft: 10, marginTop: 7}}>
                (1,287)
              </Text>
            </View>
          </View>
        ...
        <View style={{marginTop: 10}}>
          <View
            ...
            <View
              ...
              <View
                style={{width: 189, height: 78, marginTop: 10, marginLeft: 25}}>
                <Text
                  style={{
                    marginLeft: 10,
                    marginTop: 20,
              ...
              <View>
                <Image
                  style={{marginTop: 50}}
                  source={require('../../assets/BAROW.png')}
                />
              </View>
            </View>
        ...
        <View style={{width: '100%', height: 334, backgroundColor: '#fff'}}>
          ...
          <View>
            <View style={{flexDirection: 'row', marginTop: 30, marginLeft: 33}}>
              ...
              <Text style={{fontSize: 16, marginLeft: '60%', color: 'black'}}>
                ($250.00)
              </Text>
            </View>
            ...
            <View style={{flexDirection: 'row', marginTop: 30, marginLeft: 33}}>
              ...
              <Text style={{fontSize: 16, marginLeft: '29%', color: 'black'}}>
                ($250.00)
              </Text>
            </View>
          ...
          <View style={{flexDirection: 'row', marginTop: 30, marginLeft: 33}}>
            ...
            <Text style={{fontSize: 16, marginLeft: '53%', color: 'black'}}>
              ($250.00)
            </Text>
          </View>
