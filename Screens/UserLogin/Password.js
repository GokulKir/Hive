    ...
    <View style={styles.container}>
      <ScrollView>
        <View
          ...
          <Image
            style={{height: 45, width: 95, marginTop: 80}}
          ...
          <Text
            ...
            Last password? No need to worry,
          </Text>
          <Text
            style={{
              color: '#fff',
            ...
            we'll send you the password reset link
          </Text>
        </View>
        ...
        <View style={{alignItems: 'center', marginTop: 30}}>
          <TouchableOpacity
            ...
            <Image
              style={{width: 16, height: 17, marginLeft: 17}}
