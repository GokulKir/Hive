...
export default function MangeTasks ({navigation}) {
  ...
  useEffect(() => {
    console.log(
      'SERVIES_DATA>>>>>>',
      Datas?.freelencerOwnServicesList?.services,
    )
  }, [Datas])
  //Calling API //
            ...
            return (
              <View style={{alignItems: 'center', marginTop: 25}}>
                <View
                  ...
                  <Text
                    style={{marginLeft: 20, marginTop: 5, color: '#1DA1F2'}}>
                      ...
                      <View style={{flexDirection: 'row'}}>
                        <View
                          ...
                          <Image
                            ...
                            source={{uri: item?.owner?.profileImg}}
                          />
                        </View>

                        <Text style={{marginTop: 23, marginLeft: 15}}>
                          By :{' '}
                        </Text>
                        <Text
                          style={{
